...
describe Accountlog do
  ...
  describe '#deposit_log' do
     it 'shows the accounts deposit log' do
       ...
       expect(accountlog.log.last.flatten).to eq [:date, '31-12-99', :credit, 50, :balance, 100]
     end
  end
  ...
  describe '#withdraw_log' do
     it 'shows the accounts withdraw log' do
       ...
       expect(accountlog.log.last.flatten).to eq [:date, '31-12-99', :debit, 100, :balance, 200]
     end
  end
end
